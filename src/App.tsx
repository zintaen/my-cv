...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-brown-950 text-brown-100 selection:bg-gold-500/30 print:bg-brown-950 print:text-[11px] print:leading-snug">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 print:py-0 print:px-0">
        <div data-print-single-column className="grid grid-cols-1 lg:grid-cols-12 gap-12 print:grid-cols-1 print:gap-2">

          {/* Left Column - Fixed on Desktop */}
          <div className="lg:col-span-4 space-y-8 print:col-span-1 print:space-y-1">
            <div className="lg:sticky lg:top-12 space-y-8 print:space-y-1">

              {/* Avatar - hidden on print for ATS */}
              <div className="relative rounded-2xl overflow-hidden bg-brown-800 aspect-square border border-gold-500/20 shadow-2xl shadow-gold-500/5 print:hidden">
                <img src={avatarUrl} alt="Stephen Cheng" className="w-full h-full object-cover" />
              </div>

              {/* Contact Info */}
              <div className="space-y-6 bg-brown-900/50 p-8 rounded-2xl border border-gold-500/10 print:p-0 print:space-y-1 print:rounded-none print:border-none print:bg-transparent">
                <h1 className="text-4xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-gold-300 via-gold-500 to-gold-600 print:text-3xl print:text-gold-600">
                  TRỊNH THÁI ANH
                </h1>
                <h2 className="text-xl font-light tracking-wide text-gold-400 print:text-lg">
                  (STEPHEN CHENG)
                </h2>
                <p className="text-lg font-medium text-brown-100/80 border-b border-gold-500/20 pb-6 print:text-base print:pb-1 print:border-brown-300">
                  AI-First Solution Architect
                </p>

                <div className="space-y-4 pt-2 print:space-y-0.5 print:pt-0 print:flex print:flex-wrap print:gap-x-4 print:gap-y-0.5">
                  <a href="mailto:zintaen@gmail.com" className="flex items-center gap-4 text-brown-100/70 hover:text-gold-400 transition-colors print:gap-2">
                    <div className="w-10 h-10 rounded-full bg-brown-800 flex items-center justify-center border border-gold-500/20 shrink-0 print:w-5 print:h-5 print:border-none print:bg-transparent">
                      <Mail className="w-4 h-4 print:w-3.5 print:h-3.5" />
                    </div>
                    <span className="text-sm">zintaen@gmail.com</span>
                  </a>
                  <a href="tel:+84906878091" className="flex items-center gap-4 text-brown-100/70 hover:text-gold-400 transition-colors print:gap-2">
                    <div className="w-10 h-10 rounded-full bg-brown-800 flex items-center justify-center border border-gold-500/20 shrink-0 print:w-5 print:h-5 print:border-none print:bg-transparent">
                      <Phone className="w-4 h-4 print:w-3.5 print:h-3.5" />
                    </div>
                    <span className="text-sm">+84 906 878 091</span>
                  </a>
                  <div className="flex items-center gap-4 text-brown-100/70 print:gap-2">
                    <div className="w-10 h-10 rounded-full bg-brown-800 flex items-center justify-center border border-gold-500/20 shrink-0 print:w-5 print:h-5 print:border-none print:bg-transparent">
                      <MapPin className="w-4 h-4 print:w-3.5 print:h-3.5" />
                    </div>
                    <span className="text-sm">Ho Chi Minh City, Vietnam</span>
                  </div>
                  <a href="https://linkedin.com/in/zintaen" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-brown-100/70 hover:text-gold-400 transition-colors print:gap-2">
                    <div className="w-10 h-10 rounded-full bg-brown-800 flex items-center justify-center border border-gold-500/20 shrink-0 print:w-5 print:h-5 print:border-none print:bg-transparent">
                      <Linkedin className="w-4 h-4 print:w-3.5 print:h-3.5" />
                    </div>
                    <span className="text-sm truncate">linkedin.com/in/zintaen</span>
                  </a>
                </div>
              </div>
          ...
          <div className="lg:col-span-8 space-y-12 print:col-span-1 print:space-y-3">
            ...
            >
              <p className="text-lg leading-relaxed text-brown-100/80 font-light print:text-[10px] print:leading-snug">
            ...
            <motion.section
              ...
              className="space-y-8 print:space-y-2"
            >
              <div className="flex items-center gap-4 border-b border-gold-500/20 pb-4 print:pb-2 print:gap-2">
                <Code2 className="w-6 h-6 text-gold-500 print:w-4 print:h-4" />
                <h3 className="text-2xl font-serif font-semibold text-gold-400 print:text-lg">Core Competencies & Technologies</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-4 border-b border-gold-500/20 pb-4 print:pb-2 print:gap-2">
                <Briefcase className="w-6 h-6 text-gold-500 print:w-4 print:h-4" />
                <h3 className="text-2xl font-serif font-semibold text-gold-400 print:text-lg">Professional Experience</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-4 border-b border-gold-500/20 pb-4 print:pb-2 print:gap-2">
                <GraduationCap className="w-6 h-6 text-gold-500 print:w-4 print:h-4" />
                <h3 className="text-2xl font-serif font-semibold text-gold-400 print:text-lg">Education & Certifications</h3>
              </div>

              {/* Education - CMU Dominant */}
              <div className="p-6 rounded-xl bg-brown-800/50 border border-gold-500/10 print:p-2 print-break-avoid">
                <div className="flex gap-4 items-start print:gap-3">
                  <div className="w-12 h-12 rounded-full bg-gold-500/10 flex items-center justify-center shrink-0 print:w-8 print:h-8">
                    <GraduationCap className="w-6 h-6 text-gold-500 print:w-4 print:h-4" />
                  </div>
                  <div>
                    <h4 className="font-serif font-bold text-gold-300 text-xl print:text-base">Carnegie Mellon University</h4>
                    <p className="text-gold-400/80 text-sm mt-0.5 print:text-xs">Joint Program with Van Lang University</p>
                    <p className="text-brown-100/70 mt-1 print:text-xs print:mt-0">Bachelor of Engineering, Computer Software Engineering (2010 – 2016)</p>
                  </div>
                </div>
              </div>
...
function CompetencyCard({ title, skills, className = "" }: { title: string, skills: string[], className?: string }) {
  return (
    <div className={`p-6 rounded-xl bg-brown-900/40 border border-gold-500/10 hover:border-gold-500/30 transition-colors print:p-2 print:rounded-lg print-break-avoid ${className}`}>
      <h4 className="text-gold-300 font-semibold mb-4 text-lg print:text-[11px] print:mb-1">{title}</h4>
      <div className="flex flex-wrap gap-2 print:gap-1.5">
        {skills.map((skill, i) => (
          <span key={i} className="px-3 py-1.5 text-sm rounded-md bg-brown-800 text-brown-100/80 border border-gold-500/5 print:px-1.5 print:py-0 print:text-[9px] print:rounded print:leading-relaxed">
            {skill}
          </span>
        ))}
      </div>
...
function ExperienceItem({ company, role, location, date, bullets }: { company: string, role: string, location: string, date: string, bullets: string[] }) {
  return (
    <div className="relative pl-8 md:pl-0 group print:pl-0">
      <div className="md:hidden absolute left-0 top-2 w-2 h-2 rounded-full bg-gold-500 ring-4 ring-brown-950 print:hidden" />

      <div className="flex flex-col md:flex-row gap-4 md:gap-8 print:flex-col print:gap-1">
        {/* Date & Location */}
        <div className="md:w-1/3 shrink-0 md:text-right pt-1 print:w-full print:text-left print:pt-0">
          <div className="text-gold-400 font-semibold print:text-gold-600 print:text-xs print:inline">{date}</div>
          <div className="text-brown-100/50 text-sm flex items-center md:justify-end gap-1 mt-1 print:text-brown-600 print:text-[10px] print:mt-0 print:inline print:ml-2">
            <MapPin className="w-3 h-3 print:w-2.5 print:h-2.5 print:inline" /> {location}
          </div>
        </div>

        {/* Timeline Line & Dot (Desktop) */}
        <div className="hidden md:flex flex-col items-center relative print:hidden">
        ...
        {/* Content */}
        <div className="md:w-2/3 pb-12 print:w-full print:pb-1">
          <h4 className="text-2xl font-serif font-bold text-gold-300 mb-1 print:text-sm print:mb-0">{company}</h4>
          <div className="text-lg font-medium text-brown-100 mb-4 print:text-[10px] print:mb-1">{role}</div>
          <ul className="space-y-3 print:space-y-1">
            {bullets.map((bullet, i) => (
              <li key={i} className="text-brown-100/80 text-sm leading-relaxed flex items-start gap-3 print:text-[10px] print:gap-1 print:leading-snug">
                <span className="text-gold-500 mt-1.5 text-[10px] shrink-0 print:mt-1 print:text-[8px]">♦</span>
                <span>{bullet}</span>
              </li>
            ))}
          </ul>
...
function CertItem({ title, subtitle }: { title: string, subtitle?: string }) {
  return (
    <div className="p-4 rounded-xl bg-brown-900/40 border border-gold-500/10 flex items-start gap-3 print:p-1.5 print:rounded-lg print:gap-1.5 print-break-avoid">
      <Award className="w-5 h-5 text-gold-500 shrink-0 mt-0.5 print:w-3.5 print:h-3.5 print:mt-0" />
      <div>
        <span className="text-brown-100/80 text-sm leading-relaxed print:text-[10px] print:leading-snug">{title}</span>
        {subtitle && (
          <p className="text-brown-100/50 text-xs mt-1 leading-relaxed print:text-[9px] print:mt-0.5">{subtitle}</p>
        )}
      </div>
    </div>
  );
